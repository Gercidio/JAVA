...
static Scanner leia = new Scanner(System.in);
	public static void main(String[] args) {
		...
		while(true) {
			...
			System.out.println("Qual a operação matematica você deseja realizar?");
			opcao = leia.nextInt();
		...
		switch(opcao) {
		case 1	-> System.out.println("Soma: " + somar(numero1, numero2)); //-> switch lambda, reduz o case normal em uma linha. por ser um comando, não precisa do escopo
	...
	static void sobre() {
		System.out.println("Calculadora com Métodos. Gercidio.");
	}
